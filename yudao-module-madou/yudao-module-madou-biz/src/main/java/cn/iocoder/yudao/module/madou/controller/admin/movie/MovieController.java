package cn.iocoder.yudao.module.madou.controller.admin.movie;
...
import cn.iocoder.yudao.module.madou.service.movie.MovieService;

@Tag(name = "管理后台 - 影片")
@RestController
@RequestMapping("/madou/movie")
@Validated
public class MovieController {
    ...
    @PreAuthorize("@ss.hasPermission('madou:movie:create')")
    ...
    @PreAuthorize("@ss.hasPermission('madou:movie:update')")
    ...
    @PreAuthorize("@ss.hasPermission('madou:movie:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('madou:movie:query')")
    ...
    @PreAuthorize("@ss.hasPermission('madou:movie:export')")
